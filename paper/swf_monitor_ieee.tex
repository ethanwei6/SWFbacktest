...
In plain language, a strategy can make money in absolute terms and still be a poor result if a passive benchmark made much more over the same exact live period. That is why the paper emphasizes benchmark-relative results alongside raw return.
...
\begin{enumerate}[leftmargin=1.4em]
    \item \textbf{Absolute return and alpha are different here.} P2 through P5 all make money in dollar terms over the matched sample, but none of them beat passive U.S. beta. The strongest absolute PIF result, P2, still trails \texttt{SPY} by about 25.9 percentage points.
...
\toprule
\textbf{Strategy} & \textbf{Market Bench} & \textbf{Excess vs Market} & \textbf{Excess vs Cash} & \textbf{Excess vs Defensive} & \textbf{Sortino vs Cash} & \textbf{Downside Capture} & \textbf{Max Drawdown} \\
\midrule
