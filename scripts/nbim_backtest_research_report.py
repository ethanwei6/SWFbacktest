...
def main() -> None:
    ...
    lines.extend(
        [
            ...
            f"- `N7` underperformed slightly by `{fmt_pct(to_float(relative['n7']['excess_total_return']))}`. Chasing the largest sector increases appears too reactive, and missing `XLU` also caused some cash drag in one of the key rebalance windows.",
    ...
    html_lines = [
        ...
        "<p>We tested eight lag-aware NBIM strategies using official publication dates, monthly adjusted prices from Alpha Vantage, and a benchmark of VT.</p>",
        ...
        "<li>Trade date: first month-end strictly after public release</li>",
        "<li>Frequency: monthly adjusted closes</li>",
        "<li>Benchmark: VT</li>",
        "<li>Missing price coverage: XLC and XLU were unavailable because the Alpha Vantage free tier hit the daily request cap; strategies left those slices in cash</li>",
        "</ul>",
    ...
    html_lines.extend(
        [
            ...
            f"<p>N7 underperformed slightly by <strong>{escape(fmt_pct(to_float(relative['n7']['excess_total_return'])))}</strong>. Chasing the largest sector increases appears too reactive, and missing XLU caused some cash drag in a key rebalance window.</p>",
