...
BACKTEST_ROOT = PIF_ROOT / "backtests" / "p4_exit_avoidance"
...
ELIGIBILITY_PATH = BACKTEST_ROOT / "p4ea_signal_eligibility.csv"
REBALANCES_PATH = BACKTEST_ROOT / "p4ea_rebalance_events.csv"
ORDERS_PATH = BACKTEST_ROOT / "p4ea_orders.csv"
HOLDINGS_DAILY_PATH = BACKTEST_ROOT / "p4ea_holdings_daily.csv"
PORTFOLIO_DAILY_PATH = BACKTEST_ROOT / "p4ea_portfolio_daily.csv"
SUMMARY_PATH = BACKTEST_ROOT / "p4ea_summary.json"
...
def build_signal_eligibility(
    ...
    for row in signal_rows:
        ...
        elif transition_type == "likely_reduction":
            inclusion_flag = "0"
            exclusion_reason = "likely_reduction_avoidance"
        ...
        out.append(
            {
                ...
                "strategy_id": "P4_EXIT_AVOIDANCE",
                "rationale_label": "exit_avoidance",
...
def run_backtest() -> None:
    ...
    for current_date in active_dates:
        ...
        if current_date in eligible_by_trade_date:
            ...
            rebalance_id = f"P4EA-R{rebalance_map[current_date]:03d}"
                ...
                orders_rows.append(
                    {
                        ...
                        "rationale_text": "Exit previous P4 avoidance basket at the next rebalance close.",
                    }
                )
                sells_count += 1
                ...
                orders_rows.append(
                    {
                        ...
                        "rationale_text": "Buy disclosed sleeve constituent after excluding likely reductions.",
                    }
                )
                buys_count += 1
            ...
            excluded_counts = Counter(
                ...
                if row["trade_date"] == current_date and row["include_flag"] == "0"
            )
            rebalance_rows.append(
                {
                    ...
                    "likely_reduction_avoidance_count": str(excluded_counts.get("likely_reduction_avoidance", 0)),
                    ...
                    "target_weight_per_name": f"{target_weight:.12f}",
    ...
    summary = {
        "strategy_id": "P4_EXIT_AVOIDANCE",
        "strategy_name": "PIF Exit Avoidance",
