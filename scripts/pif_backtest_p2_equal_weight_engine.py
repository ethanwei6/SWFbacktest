...
BACKTEST_ROOT = PIF_ROOT / "backtests" / "p2_equal_weight"
...
ELIGIBILITY_PATH = BACKTEST_ROOT / "p2ew_signal_eligibility.csv"
REBALANCES_PATH = BACKTEST_ROOT / "p2ew_rebalance_events.csv"
ORDERS_PATH = BACKTEST_ROOT / "p2ew_orders.csv"
HOLDINGS_DAILY_PATH = BACKTEST_ROOT / "p2ew_holdings_daily.csv"
PORTFOLIO_DAILY_PATH = BACKTEST_ROOT / "p2ew_portfolio_daily.csv"
SUMMARY_PATH = BACKTEST_ROOT / "p2ew_summary.json"
        ...
        out.append(
            {
                ...
                "strategy_id": "P2_EQUAL_WEIGHT",
                "rationale_label": "full_sleeve_holding",
...
def run_backtest() -> None:
    ...
    for current_date in active_dates:
        ...
        if current_date in eligible_by_trade_date:
            ...
            rebalance_id = f"P2EW-R{rebalance_map[current_date]:03d}"
                ...
                orders_rows.append(
                    {
                        ...
                        "rationale_text": "Exit previous P2 equal-weight sleeve at the next rebalance close.",
                    }
                )
                sells_count += 1
                ...
                orders_rows.append(
                    {
                        ...
                        "disclosed_portfolio_weight": signal["disclosed_portfolio_weight"],
                        "rationale_text": "Buy disclosed PIF sleeve constituent at the first tradable NYSE close after publication.",
                    }
                )
                buys_count += 1
    ...
    summary = {
        "strategy_id": "P2_EQUAL_WEIGHT",
        "strategy_name": "PIF Full Disclosed Sleeve Mirror Equal Weight",
